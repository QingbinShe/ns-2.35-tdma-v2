...
MacTdma::MacTdma(PHY_MIB* p) : 
	...
	*/
	...
	slotTb_.slotTable = new slotToDst[max_slot_num_];
...
void MacTdma::slotHandler(Event *e)
{
	...
	/*use slot0 to send or receive hello, slot1 to send or receive rreq, rrep, error packet of AODV
